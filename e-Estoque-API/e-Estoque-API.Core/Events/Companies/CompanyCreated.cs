...
namespace e_Estoque_API.Core.Events.Companies
{
    public class CompanyCreated : IDomainEvent
    {
        ...
        public CompanyCreated(Guid id, string name, string docId, string email, string description, string phoneNumber, Guid idCompanyAddress, Address companyAddress)
        {
            Id = id;
            Name = name;
            DocId = docId;

...
namespace e_Estoque_API.Core.Events.Customers
{
    public class CustomerCreated : IDomainEvent
    {
        ...
        public CustomerCreated(Guid id, string name, string docId, string email, string description, string phoneNumber, Guid idCompanyAddress, Address companyAddress)
        {
            Id = id;
            Name = name;
            DocId = docId;
